...
├── firestore.rules               # Firestore 보안 규칙 (방문자 카운터·AI 툴 포함)
...
4. **AI 툴 관리** — 관리자 로그인 시 "AI 툴" 섹션에 "AI 툴 추가" 버튼이 노출되어
   이름·소개·설명·링크·태그·아이콘으로 새 AI 툴 카드를 추가/삭제할 수 있습니다(Firestore `ai_tools`).
